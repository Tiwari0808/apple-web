...
Files: macbook-16.glb [639.28KB] > C:\Users\Divyanshu Tiwari\Desktop\react\macbook\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  useEffect(() => {
    ...
    scene.traverse((item) => {
      if (item.isMesh) {
        if (!noChangeParts.includes(item.name)) {
          item.material.color = new Color(color);
        }
      }
    })
